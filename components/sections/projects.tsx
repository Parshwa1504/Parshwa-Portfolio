...
const projects = [
  ...
  summary: "End-to-end A/B test analysis on 290,584 user sessions using Python, scipy, and statsmodels to determine whether a new landing page design increased conversions.",
  description: "Analyzed a 22-day landing page A/B test comparing control vs. treatment groups across ~290K unique users to make a data-driven launch decision. Cleaned mismatched assignments and duplicates, computed group-level conversion rates, ran Chi-square and Z-tests for proportions, performed power analysis to validate test reliability, and segmented results by day of week to detect novelty and weekend effects. Visualized conversion rates, daily trends, and 95% confidence intervals to communicate findings clearly.",
  keyImpact: "Recommended NOT launching the new page treatment showed a -1.33% relative decline with p = 0.19 and only 25.9% statistical power, proving the test was underpowered and saving the business from shipping a losing variant.",
  tags: ["Python", "pandas", "scipy", "statsmodels", "A/B Testing", "Hypothesis Testing", "Power Analysis"],
  github: "https://github.com/Parshwa1504/AB-Test-Ecommerce-Analysis",
  },
  {
  id: 2,
  category: "data-analytics",
  ...
  summary: "End-to-end HR analytics project analyzing employee attrition across 1,470 employees using SQL, Python, and Tableau, with a logistic regression model to identify at-risk employees.",
  description: "Built a comprehensive HR analytics solution to understand who is leaving, why, and which active employees are at risk next. Loaded the IBM HR dataset into SQLite and wrote 6 business SQL queries, performed full EDA with 5 visualizations, trained a class-balanced logistic regression model, and ranked all 1,233 active employees into High/Medium/Low risk tiers. Delivered an interactive Tableau dashboard with KPI cards, department/role/salary/tenure breakdowns, and overtime impact analysis.",
  keyImpact: "Achieved 75% model accuracy with 77% recall, identified overtime as the #1 attrition driver, and surfaced targeted retention actions projected to save $330K–$660K annually.",
  tags: ["Python", "SQL", "SQLite", "scikit-learn", "Tableau", "pandas", "Logistic Regression"],
  github: "https://github.com/Parshwa1504/HR-Analytics-Employee-Attrition",
  },
  {
  id: 3,
  category: "data-analytics",
  categoryLabel: "Data Analytics",
  title: "E-Commerce Cohort & Revenue Analysis",
  summary: "Revenue and cohort analysis of 96,470 Brazilian e-commerce orders using Python, SQL, and Power BI to understand acquisition, segmentation, and revenue concentration.",
  description: "Analyzed the Olist Brazilian E-Commerce dataset spanning 8 related tables and 110K+ order items to uncover growth drivers across products, states, sellers, and payment methods. Merged and cleaned data in Python, wrote 6 business SQL queries with window functions and CASE logic, built a monthly revenue cohort analysis, and segmented all 96,470 customers using RFM scoring into Champions, Loyal, Potential Loyalists, and At Risk tiers. Delivered an interactive 6-visual Power BI dashboard with state/month slicers.",
  keyImpact: "Surfaced $19.7M in total revenue with São Paulo + Rio driving 59% of sales, and identified $5.8M in revenue protection via a Champions VIP program and Boleto-to-credit-card conversion uplift of ~$356K.",
  tags: ["Python", "SQL", "SQLite", "Power BI", "pandas", "RFM Segmentation", "Cohort Analysis"],
  github: "https://github.com/Parshwa1504/Ecommerce-Cohort-Revenue-Analysis",
  },
  {
  id: 4,
  category: "data-analytics",
  ...
  summary: "Comprehensive bank loan performance and risk analysis across 38,576 loan records using Excel and Tableau with MTD/PMTD/MoM KPI tracking.",
  description: "Built a financial intelligence dashboard analyzing loan applications, funded amounts, repayments, interest rates, and debt-to-income ratios across 38K+ records. Engineered KPIs in Excel using pivot tables and custom formulas, wrote SQL queries for data modeling, and designed multi-layered Tableau dashboards (Summary, Overview, Detail) with drill-down capability on borrower segments, loan purposes, ownership types, and states. Categorized loans into good vs. bad to evaluate repayment behavior and lending risk.",
  keyImpact: "Delivered stakeholder-ready dashboards tracking loan performance with MTD/PMTD/MoM trends, enabling financial decision-makers to assess risk and repayment health across borrower segments at a glance.",
  tags: ["Excel", "SQL", "Tableau", "Pivot Tables", "KPI Engineering", "Business Intelligence"],
  ...
  summary: "End-to-end telecom churn analysis across 7,043 customers using SQL, Python EDA, risk segmentation, and logistic regression to identify at-risk customers.",
  description: "Tackled a 26.54% annual churn problem by answering why customers churn, who is most at risk, and what the retention team should do first. Ran 5 SQL queries in SQLite to slice KPIs by contract, tenure, and payment method, built 7 EDA visualizations, segmented all 7,043 customers into High/Medium/Low risk tiers via a scoring model, and trained an interpretable logistic regression on 19 features so stakeholders understand why each customer is flagged.",
  keyImpact: "Achieved 80% model accuracy, identified a 15x churn gap between month-to-month and 2-year contracts, and prescribed 3 high-impact actions projected to retain ~147 customers worth ~$130K in annual revenue.",
  tags: ["Python", "SQL", "SQLite", "scikit-learn", "pandas", "matplotlib", "Logistic Regression", "Customer Segmentation"],
  github: "https://github.com/Parshwa1504/Customer-Churn-Analysis",
  },
  {
    id: 6,
    category: "data-analytics",
